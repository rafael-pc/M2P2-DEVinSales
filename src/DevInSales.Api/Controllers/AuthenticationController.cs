...
namespace DevInSales.Api.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        public IActionResult PostAdministrador(Authentication autenticacao)
        {
        ...
        [HttpPost("Gerente")]
        public IActionResult PostGerente(Authentication autenticacao)
        {
            /* Montar autenticação do JWT */
            /* Simulando o acesso ao banco de dados e trazendo os dados do usuário */
            var colaborador = new Colaborador("Gerente");
        ...
        [HttpPost("Usuario")]
        public IActionResult PostUsuario(Authentication autenticacao)
        {
            /* Montar autenticação do JWT */
            /* Simulando o acesso ao banco de dados e trazendo os dados do usuário */
            var colaborador = new Colaborador("Usuario");
